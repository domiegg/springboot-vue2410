	...
	<body>
			<form action="updateYuyuezhidao.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.jiaoshibianhao.value='${yuyuezhidao.jiaoshibianhao}';</script>	<script language="javascript">document.form1.xingming.value='${yuyuezhidao.xingming}';</script>	<script language="javascript">document.form1.yuyueren.value='${yuyuezhidao.yuyueren}';</script>	<script language="javascript">document.form1.yuyueshijian.value='${yuyuezhidao.yuyueshijian}';</script>	<script language="javascript">document.form1.lianxifangshi.value='${yuyuezhidao.lianxifangshi}';</script>	<script language="javascript">document.form1.beizhu.value='${yuyuezhidao.beizhu}';</script>	
					 </table>
			</form>
   </body>
</html>
