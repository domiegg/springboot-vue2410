...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateKaoyanziyuan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改考研资源<input type="hidden" name="id" value="${kaoyanziyuan.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.ziyuanbianhao.value='${kaoyanziyuan.ziyuanbianhao}';</script>	<script language="javascript">document.form1.ziyuanmingcheng.value='${kaoyanziyuan.ziyuanmingcheng}';</script>	<script language="javascript">document.form1.wenjian.value='${kaoyanziyuan.wenjian}';</script>	<script language="javascript">document.form1.xiangxi.value='${kaoyanziyuan.xiangxi}';</script>	<script language="javascript">document.form1.faburen.value='${kaoyanziyuan.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
