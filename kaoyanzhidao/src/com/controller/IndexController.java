...
public class IndexController {
	...
	@Resource	private JiaoshixinxiServer jiaoshixinxiServer;	//jixacxishxu3
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Jiaoshixinxi> syjiaoshixinxi1=jiaoshixinxiServer.getsyjiaoshixinxi1(null);		List<Jiaoshixinxi> syjiaoshixinxi2=jiaoshixinxiServer.getsyjiaoshixinxi2(null);		List<Jiaoshixinxi> syjiaoshixinxi3=jiaoshixinxiServer.getsyjiaoshixinxi3(null);		//jixacxishxu4
	    ...
	    map.put("syjiaoshixinxi1", syjiaoshixinxi1);	    map.put("syjiaoshixinxi2", syjiaoshixinxi2);	    map.put("syjiaoshixinxi3", syjiaoshixinxi3);	    //jixacxishxu5
